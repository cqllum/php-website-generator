                    ...
                    <div class="container-fluid">
                        ...
                        <?php if (isset($_POST['saveChanges'])) {
                          ...
                          $newData = json_decode(file_get_contents(__DIR__ . "/../includes/site.json"));
                            ...
                            array_push($newData->projects, array('status'=> '1', 'projectId' => rand(1000,999), 'projectCover'=>$_POST['cover'], 'projectName'=> $_POST['projectName'],'projectLocation'=> $_POST['location'], 'projectType'=> $_POST['category'], 'projectDetails' => $_POST['content'], 'projectBudget' => $_POST['budget'], 'projectCompleted' => $_POST['completedOn']));
                            ...
                            <div class="col-lg-6 col-md-12 col-xs-12 col-sm-12">
                                ...
                                <div class="card-header">
                                        <strong>Projects</strong> Add new project to portfolio
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="location"  class="form-control">
                                                </div>
                                        </div>
                                         ...
                                         <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date" id="text-input" name="completedOn" class="form-control">
                                                </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Budget</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="budget"  class="form-control">
                                                </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                <div class="card-header">
                                        <strong>All Projects </strong> What have you accomplished?
                                        <small class="form-text text-muted">All of your projects are shown below</small>
                                    </div>
                                    <div class="card-body card-block">
                                                  ...
                                                  <?php foreach ($data['projects'] as $tag) {  

                                                    echo " <div class='row form-group mt-3 mb-3'>
                                                    <div class='col col-md-3'>
                                                    <img src='../$tag[projectCover]' style='height: 100px;width:100px;'>
                                                    
                                                </div>";

                                                    echo '<div class="col-12 col-md-7">';
                                                      echo " <h4>$tag[projectName]</h4> Location: $tag[projectLocation]<br>Budget: $tag[projectBudget]<br>Category: $tag[projectType]<br>Details: $tag[projectDetails]";
                                                    echo '</div>
                                                    
                                                    <div class="col-md-2"><a href="../includes/del.val.php?t=1&v='.$tag['projectId'].'" >Delete</a></div></div>';
                                                    }
                                                        ?>
